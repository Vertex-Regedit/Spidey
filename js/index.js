document.addEventListener('DOMContentLoaded', function() {
    // Get references to the login panel, form, content container, and overlay
    ...
    // Hide content and show the login panel when the page loads
    ...
    loginForm.addEventListener('submit', function(event) {
        ...
        if (validateLogin(username, password)) {
            // Hide the login panel and overlay, and show the content
